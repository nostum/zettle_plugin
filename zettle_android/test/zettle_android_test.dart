...
class MockZettleAndroidPlatform
...
void main() {
  ...
  test('getPlatformVersion', () async {
    ZettleAndroid zettleAndroidPlugin = ZettleAndroid();
    MockZettleAndroidPlatform fakePlatform = MockZettleAndroidPlatform();
    ZettlePlatform.instance = fakePlatform;

    expect(await zettleAndroidPlugin.getPlatformVersion(), '42');
  });
}
